...
```json
{
  ...
  "slides": [
    ...
    {
      "layout": "chart",
      "title": "Pre-rendered Chart as Image",
      "subtitle": "<center>Generated by gen-chart (PNG)</center>",
      "chart": { "type": "image", "path": "/abs/path/candlestick_chart.png" },
      "footnote": "Use `type:\"image\"` for chart types PptxGenJS cannot render natively (candlestick, heatmap, etc.)"
    }
  ]
}
```
